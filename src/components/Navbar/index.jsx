...
const Navbar = () => {
  return (
    <nav className="flex items-center justify-between px-4 py-4 bg-white font-sans p-2 border-b-2 border-gray-200 ">
      {/* Logo */}
      <Link to="/">
      ...
      {/* Navigation Links */}
      <ul className="flex space-x-20 font-medium text-lg">
